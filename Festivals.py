...
def create_Fesival_pdf(filename, ps, pagesize, title="Festivals"):
    ...
    try:
        ...
        for i in range(len(festivalevents)):
            ...
            c.setFont(festivalfont, 22)
            c.drawString(festival_x + 82, festival_y + 148, monthnames[festivalevents[i].startmonth-1])
            c.setFont(festivalfont, 25)
            c.drawString(festival_x + 125, festival_y - 65, str(festivalevents[i].endday))
            c.setFont(festivalfont, 22)
            c.drawString(festival_x + 132, festival_y - 32, monthnames[festivalevents[i].endmonth-1])
            c.setFillColor(black)
            c.setFont(festivalfont, 25)
